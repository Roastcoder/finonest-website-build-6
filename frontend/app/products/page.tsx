...
const products = [
  {
    ...
    description:
      "Master digital marketing and finance with expert-led courses. Build skills in SEO, social media, financial planning, and business growth strategies.",
    rate: "From ₹12,999",
  ...
  },
  {
    ...
    description:
      "Get accurate market valuation of your car instantly. Use it for selling, buying, or loan applications with our advanced AI-powered tool.",
    rate: "Free",
    maxAmount: "Unlimited",
    tenure: "Instant",
    processingFee: "₹0",
